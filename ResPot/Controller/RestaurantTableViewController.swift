...
//        self.navigationItem.searchController = searchController
    ...
    override func tableView(_ tableView: UITableView, trailingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        ...
        let shareAction = UIContextualAction(style: .normal, title: NSLocalizedString("Share", comment: "Share")) { (action, sourceView, completionHandler) in
            let defaultText = NSLocalizedString("Just checking in at ", comment: "Just checking in at ") + NSLocalizedString(self.restaurants[indexPath.row].name!, comment: self.restaurants[indexPath.row].name!)
    ...
    func prepareNotification() {
        ...
        // Create and register custom actions
        let categoryIdentifier = "respot.restaurantaction"
        let makeReservationAction = UNNotificationAction(identifier: "respot.makeReservation", title: "Reserve a table", options: [.foreground])
        let cancelAction = UNNotificationAction(identifier: "respot.cancel", title: "Later", options: [])
        ...
        let request = UNNotificationRequest(identifier: "respot.restaurantSuggestion", content: content, trigger: trigger)
